...
public class TdRegFrontResourceIT {
    ...
    @Test
    @Transactional
    public void checkTipoImpuestodIsRequired() throws Exception {
        int databaseSizeBeforeTest = tdRegFrontRepository.findAll().size();
        // set the field null
        tdRegFront.setTipoImpuestod(null);
    ...
    public void checkTipoSolicituddIsRequired() throws Exception {
        int databaseSizeBeforeTest = tdRegFrontRepository.findAll().size();
        // set the field null
        tdRegFront.setTipoSolicitudd(null);
    ...
    @Test
    @Transactional
    public void checkEjerciciodIsRequired() throws Exception {
        int databaseSizeBeforeTest = tdRegFrontRepository.findAll().size();
        // set the field null
        tdRegFront.setEjerciciod(null);
